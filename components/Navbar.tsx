  ...
  return (
    <>
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
        <nav
          className={`pointer-events-auto w-full max-w-6xl transition-all duration-300 rounded-full px-6 py-3 flex items-center justify-between ${scrolled || isOpen
        ...
        >
          <div className="flex flex-col space-y-6 text-center">
            ...
            <Link
              href="/contact"
              onClick={() => setIsOpen(false)}
              className="bg-black text-white px-8 py-5 rounded-full font-bold text-xl mt-8 shadow-xl inline-block"
            >
              Let's Talk
            </Link>
          </div>
