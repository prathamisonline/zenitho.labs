    ...
    const products = [
        {
            ...
            url: "https://berryflow.io", // Placeholder URL, usually
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {products.map((product, idx) => (
                        <div key={idx} className={`rounded-3xl p-8 border hover:shadow-xl transition-all hover:-translate-y-1 ${product.color}`}>
                            ...
                            <a href={product.url} className="inline-flex items-center gap-2 font-bold text-sm bg-white/50 px-4 py-2 rounded-lg hover:bg-white transition-colors">
