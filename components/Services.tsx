      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-6 text-5xl font-black text-black tracking-tight">How we help you win.</h2>
            <p className="mt-6 text-xl text-gray-500 max-w-2xl">
              Comprehensive solutions designed to accelerate your growth and eliminate bottlenecks. We don't just build, we solve.
            </p>
          </div>
        </div>
